...
const data = [
  ...
  {
    id: 2,
    title: "we deliver your order wherever you are in ISTANBUL",
    image: "/slide2.png",
  },
  {
    id: 3,
    title: "the best pizza to not share with anyone",
    image: "/slide3.png",
  },
];
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] lg:flex-row bg-sky-50">
      ...
      <div className="flex-1 flex items-center justify-center flex-col gap-8 text-emerald-500 font-bold">
        ...
        <button className="bg-emerald-500 text-white py-4 px-8 rounded-lg">
          Order Now
        </button>
      </div>
      {/* IMAGE CONTAINER */}
